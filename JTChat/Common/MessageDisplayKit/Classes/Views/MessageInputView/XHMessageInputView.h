...
typedef NS_ENUM(NSInteger, XHMessageInputType) {
    XHMessageInputTypeNormal,
    XHMessageInputTypeXiaoMiShu
};
...
- (instancetype)initWithFrame:(CGRect)frame withType:(XHMessageInputType)inputType;
