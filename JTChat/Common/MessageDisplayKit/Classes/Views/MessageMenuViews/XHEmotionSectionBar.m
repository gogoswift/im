...
#define kXHStoreManagerItemWidth 45
...
- (void)setup {
    ...
    if (self.isShowEmotionStoreButton) {
        ...
        storeManagerItemButton.titleLabel.font = [UIFont systemFontOfSize:15];
        [storeManagerItemButton setTitleColor:[UIColor colorWithRed:0.18 green:0.37 blue:0.85 alpha:1] forState:UIControlStateNormal];
        [storeManagerItemButton setTitleColor:[UIColor colorWithRed:0.47 green:0.58 blue:0.91 alpha:1] forState:UIControlStateHighlighted];
