...
// 每行有4个
#define kXHShareMenuPerRowItemCount 3
...
- (void)setup {
    ...
    if (!_shareMenuItemTitleLabel) {
        ...
        shareMenuItemTitleLabel.textColor = [UIColor colorWithHexString:@"0x8b8b8b"];
...
- (void)reloadData {
    ...
    for (XHShareMenuItem *shareMenuItem in self.shareMenuItems) {
        ...
        //                                                                  atIndex:index
        //                                                                   onPage:page];
        CGFloat padding = (IM_WIDTH_SCREEN - self.shareMenuItems.count *kXHShareMenuItemWidth)/(self.shareMenuItems.count + 1);
        CGRect shareMenuItemViewFrame = CGRectMake(padding*(index + 1) + kXHShareMenuItemWidth*index, 12, kXHShareMenuItemWidth, KXHShareMenuItemHeight);
